...
if(isset($_REQUEST['guardar'])){
    ...
    (email,pass,nombre)VALUES('".$email."','".$pass."','".$nombre."');";
                        ...
                        <div class="card-body">
                           <form action="panel.php?modulo=crearUsuario" method="post">
                            ...
                            <div class="form-group">
                              ...
                              <input type="password" name="pass" id="" class="form-control" placeholder="Contraseña" aria-describedby="helpId">
                              
                            </div>
                            <div class="form-group">
                              <label>Nombre</label>
                              <input type="text" name="nombre" id="" class="form-control" placeholder="Nombre" aria-describedby="helpId">
